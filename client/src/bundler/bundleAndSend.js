...
export const bundleAndSend = async (txns) => {
    ...
    // after bridging
    const bananaInstanceOptimism = new Banana(Chains.fuji, 'register');
    ...
    const signerAvalanche = walletOptimism.getSigner();
    ...
    mumbaiTxn.value = ethers.utils.parseEther(String(Number(mumbaiTxn.value) / 10 ** 18));
